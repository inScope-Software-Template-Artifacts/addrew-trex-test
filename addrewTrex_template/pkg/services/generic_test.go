...
import (
	...
	"github.com/openshift-online/addrewTrex/pkg/db/db_session"
...
func TestSQLTranslation(t *testing.T) {
	...
	tests := []map[string]interface{}{
		{
			"search": "garbage",
			"error":  "addrewTrex-21: Failed to parse search query: garbage",
		},
		{
			"search": "id in ('123')",
			"error":  "addrewTrex-21: dinosaurs.id is not a valid field name",
		},
	}
