...
import (
	...
	"github.com/openshift-online/addrewTrex/cmd/addrewTrex-service/server"
	...
	"github.com/openshift-online/addrewTrex/test/factories"
	"github.com/openshift-online/addrewTrex/test/mocks"
)
...
func (helper *Helper) RestURL(path string) string {
	...
	return fmt.Sprintf("%s://%s/api/addrewTrex/v1%s", protocol, helper.AppConfig.Server.BindAddress, path)
}
