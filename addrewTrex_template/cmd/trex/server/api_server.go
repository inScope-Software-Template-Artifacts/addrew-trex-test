...
import (
	...
	"github.com/openshift-online/addrewTrex/data/generated/openapi"
...
func NewAPIServer() Server {
	...
	if env().Config.Server.EnableJWT {
		...
		mainHandler, err = authentication.NewHandler().
			...
			Public("^/api/addrewTrex/?$").
			Public("^/api/addrewTrex/v1/?$").
			Public("^/api/addrewTrex/v1/openapi/?$").
			Public("^/api/addrewTrex/v1/errors(/.*)?$").
			Next(mainHandler).
			Build()
